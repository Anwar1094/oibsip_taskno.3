...
class Generator():
    ...
    def setElement(self):
        ...
        self.Strength = CTkOptionMenu(win, fg_color="#5e7ef7", variable=self.strength, values=["Simple", "Strong", "Very Strong"], command=self.Check)
        ...
        self.Length = CTkOptionMenu(win, fg_color="#5e7ef7", variable=self.length, values=[str(x) for x in range(8, 21)])
        ...
        self.r1 = CTkRadioButton(win, fg_color="#5e7ef7", text="Numeric", variable=self.type, value="Numeric")
        self.r2 = CTkRadioButton(win, fg_color="#5e7ef7", text="Alphabetical", variable=self.type, value="Alphabetical")
        ...
        self.submitbtn =  CTkButton(win, fg_color="#5e7ef7", text="Submit", command=self.setEntry)
        self.submitbtn.place(x=10, y=480)
        CTkButton(win, fg_color="#5e7ef7", text="Clear", command=self.Clear).place(x=180, y=480)
        self.cpybtn = CTkButton(win, fg_color="#5e7ef7", text="Copy", state=DISABLED, command=self.Copy)
